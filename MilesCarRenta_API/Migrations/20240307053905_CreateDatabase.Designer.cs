...
namespace MilesCarRenta_API.Migrations
{
    ...
    [Migration("20240307053905_CreateDatabase")]
            ...
            modelBuilder.Entity("MilesCarRenta_API.Models.Car", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Brand = "Chevrolet",
                            Created_at = new DateTime(2024, 3, 7, 0, 39, 5, 482, DateTimeKind.Local).AddTicks(9584),
                            Engine_capacity = "1600cc",
                            Location_id = 1,
                            Model = "2018",
                            Plate_number = "PTH15E",
                            Status = "D",
                            Updated_at = new DateTime(2024, 3, 7, 0, 39, 5, 482, DateTimeKind.Local).AddTicks(9597),
                        ...
                        new
                        {
                            Id = 2,
                            Brand = "Chevrolet",
                            Created_at = new DateTime(2024, 3, 7, 0, 39, 5, 482, DateTimeKind.Local).AddTicks(9600),
                            Engine_capacity = "1200cc",
                            Location_id = 1,
                            Model = "2022",
                            Plate_number = "KNQ32",
                            Status = "D",
                            Updated_at = new DateTime(2024, 3, 7, 0, 39, 5, 482, DateTimeKind.Local).AddTicks(9601),
                        ...
                        new
                        {
                            Id = 3,
                            Brand = "Mazda",
                            Created_at = new DateTime(2024, 3, 7, 0, 39, 5, 482, DateTimeKind.Local).AddTicks(9603),
                            Engine_capacity = "1400cc",
                            Location_id = 2,
                            Model = "2009",
                            Plate_number = "ATR21",
                            Status = "O",
                            Updated_at = new DateTime(2024, 3, 7, 0, 39, 5, 482, DateTimeKind.Local).AddTicks(9604),
                            Vehicule_type = "Automovil"
                        },
                        new
                        {
                            Id = 4,
                            Brand = "Nissan",
                            Created_at = new DateTime(2024, 3, 7, 0, 39, 5, 482, DateTimeKind.Local).AddTicks(9605),
                            Engine_capacity = "1600cc",
                            Location_id = 3,
                            Model = "2017",
                            Plate_number = "KNP98",
                            Status = "O",
                            Updated_at = new DateTime(2024, 3, 7, 0, 39, 5, 482, DateTimeKind.Local).AddTicks(9606),
                        ...
                        new
                        {
                            Id = 5,
                            Brand = "Nissan",
                            Created_at = new DateTime(2024, 3, 7, 0, 39, 5, 482, DateTimeKind.Local).AddTicks(9607),
                            Engine_capacity = "1600cc",
                            Location_id = 4,
                            Model = "2017",
                            Plate_number = "KNP98",
                            Status = "O",
                            Updated_at = new DateTime(2024, 3, 7, 0, 39, 5, 482, DateTimeKind.Local).AddTicks(9608),
                            Vehicule_type = "Campero"
                        },
                        new
                        {
                            Id = 6,
                            Brand = "Wolsvagen",
                            Created_at = new DateTime(2024, 3, 7, 0, 39, 5, 482, DateTimeKind.Local).AddTicks(9609),
                            Engine_capacity = "1600cc",
                            Location_id = 3,
                            Model = "2007",
                            Plate_number = "ARS45",
                            Status = "D",
                            Updated_at = new DateTime(2024, 3, 7, 0, 39, 5, 482, DateTimeKind.Local).AddTicks(9610),
                            Vehicule_type = "Sub"
                        });
                });
